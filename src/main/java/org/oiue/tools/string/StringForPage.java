 ...
 * 类说明:
 * 
 * @author Every E-mail/MSN:mwgjkf@hotmail.com QQ:30130942 StringForPage 1.0 Apr 18, 2009 2:03:02 PM StringToPage
 */
public class StringForPage {
	...
	/**
	 * 方法说明： 滤除 HTML 标记,因为 XML 中转义字符依然有效, 因此把特殊字符过滤成中文的全角字符. CreateTime Apr 18, 2009 2:14:47 PM
	...
	/**
	 * 方法说明： 将 TEXT 文本转换为 HTML 代码, 已便于网页正确的显示出来. CreateTime Apr 18, 2009 3:31:46 PM
	 * @param sourceStr 源字符串
	 * @return 滤除后的字符串
	 */
	...
	/**
	 * 方法说明： 滤除 HTML 代码 为文本代码. CreateTime Apr 18, 2009 3:33:46 PM
	 * @param sourceStr 源串
	 * @return 结果
	 */
	...
	/**
	 * 方法说明： SQL语句转换 将单个的 ' 换成 ''; SQL 规则:如果单引号中的字符串包含一个嵌入的引号,可以使用两个单引号表示嵌入的单引号. CreateTime Apr 18, 2009 3:23:01 PM
	 * @param sourceStr 源字符串
	 * @return 滤除后的字符串
	 */
	...
	/**
	 * 方法说明： 检查指定的 Web 应用程序目录下的文件是否存在. CreateTime Apr 18, 2009 10:42:21 PM
	 * @param application JSP/Servlet 的 ServletContext
	 * @param filePath 相对文件路径
	...
	/**
	 * 方法说明： 将字符串转换为一个 JavaScript 的 document.location 改变调用. eg: htmlAlert("a.jsp"); returns &lt;SCRIPTlanguage="JavaScript"&gt;document.location="a.jsp";&lt;/SCRIPT&gt; CreateTime Apr 18, 2009 11:30:03 PM
	...
	/**
	 * 方法说明： 将字符串转换为一个 JavaScript 的 alert 调用. eg: htmlAlert("What?"); returns &lt;SCRIPT language="JavaScript"&gt;alert("What?")&lt;/SCRIPT&gt; CreateTime Apr 18, 2009 11:32:38 PM
