...
public class TimeUtil extends StringForDate {
	 ...
	 * @param p_format String 格式1:"yyyy-MM-dd" 格式2:"yyyy-MM-dd hh:mm:ss EE/yyyy-MM-dd HH:mm:ss EE" 格式3:"yyyy年MM月dd日 hh:mm:ss EE/yyyy年MM月dd日 HH:mm:ss EE" 说明: 年-月-日 时:分:秒 星期 注意MM/mm大小写
	 * @return String
	 * @throws ParseException 转换异常
	 * @author Every : 2011-4-18
	 */
