 ...
 * 类说明:
 * 
 * @author Every E-mail/MSN:mwgjkf@hotmail.com QQ:30130942 StringUtil 1.0 Apr 18, 2009 2:06:54 PM StringUtil
 */
...
public class StringUtil {
	...
	/**
	 * 方法说明： 获得源字符串的字节长度(即二进制字节数), 用于发送短信时判断是否超出长度. CreateTime Apr 18, 2009 3:48:22 PM
	 * @param sourceStr 源字符串
	...
	/**
	 * 方法说明： 清除字符串结尾的空格. CreateTime Apr 18, 2009 3:56:56 PM
	 * @param sourceStr 源字符串
	 * @return 滤除后的字符串
	 */
	...
	/**
	 * 方法说明： 将字符串转换为 int. CreateTime Apr 18, 2009 7:14:35 PM
	...
	/**
	 * 方法说明： 判断字符串是否全是数字字符. CreateTime Apr 18, 2009 7:36:52 PM
	 * @param sourceStr 输入的字符串
	...
	/**
	 * 方法说明： 转换字符串的内码. CreateTime Apr 18, 2009 7:43:30 PM
	 * @param sourceStr 源字符串
	...
	/**
	 * 方法说明： 转换数据的内码(从 ISO8859 转换到 UTF-8). CreateTime Apr 18, 2009 7:40:54 PM
	 * @param sourceStr 源字符串
	 * @return 转码后的字符串
	 * @throws UnsupportedEncodingException 异常
	 */
	...
	/**
	 * 方法说明： 转换数据的内码(从 UTF-8 转换到 ISO8859). CreateTime Apr 18, 2009 7:46:15 PM
	 * @param sourceStr 源字符串
	 * @return 转码后的字符串
	 * @throws UnsupportedEncodingException 异常
	 */
	...
	/**
	 * 方法说明： Change the null string value to "", if not null, then return it self, use this to avoid display a null string to "null". CreateTime Apr 18, 2009 11:34:23 PM
	...
	/**
	 * 方法说明： Return the limited length string of the input string (added at:April 10, 2004). CreateTime Apr 18, 2009 11:36:10 PM
	 * @param input String
	 * @param maxLength int
